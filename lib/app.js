...
app.put('/messier_catalog/:id', async(req, res) => {
    ...
    try {
        ...
        SET messier_id = $1, ngc_ic_num = $2, common_name = $3, image = $4, object_type = $5, distance_from_earth_kly = $6, constellation = $7, apparent_mag = $8, right_asc = $9, declination = $10, observation_completed = $11
        where id=$12 
        returning *;
    `,
        [
...
app.get('/messier_catalog', async(req, res) => {
    try {
        const data = await client.query('SELECT DISTINCT object_type from messier_catalog');
