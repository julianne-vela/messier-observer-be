...
app.post('/messier_catalog', async(req, res) => {
  try {
    const data = await client.query(`
        INSERT into messier_catalog (messier_id, ngc_ic_num, common_name, image, object_type, distance_from_earth_kly, constellation, apparent_mag, right_asc, declination, observation_completed, owner_id)
